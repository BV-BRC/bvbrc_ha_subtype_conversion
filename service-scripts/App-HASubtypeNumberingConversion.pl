#
# The HASubtypeNumberingConversion application
#
...
my $script = Bio::KBase::AppService::AppScript->new(\&process_hasubtypenumberingconversion, \&preflight);
...
sub preflight
{
    ...
    print STDERR "preflight hasubtypenumberingconversion ", Dumper($params, $app);
...
sub process_hasubtypenumberingconversion
{
    my($app, $app_def, $raw_params, $params) = @_;

    print 'Proc ha subtype numbering conversion ', Dumper($app_def, $raw_params, $params);
    ...
    my @cmd = ("run_ha_subtype_numbering_conversion","-o",$work_dir,"--jfile", $jdesc);
